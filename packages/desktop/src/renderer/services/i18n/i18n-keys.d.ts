...
export type I18nKey =
  ...
  | 'login.registerCodeResendIn'
  | 'login.registerCodeSent'
  | 'login.registerErrors.email_verification_required'
  | 'login.registerErrors.invalid_email'
  | 'login.registerErrors.invalid_params'
  | 'login.registerErrors.network_error'
  | 'login.registerErrors.password_mismatch'
  | 'login.registerErrors.password_register_disabled'
  | 'login.registerErrors.rate_limited'
  | 'login.registerErrors.register_disabled'
  | 'login.registerErrors.server_error'
  | 'login.registerErrors.unknown'
  | 'login.registerErrors.user_exists'
  | 'login.registerErrors.verification_code_error'
  | 'login.registerLink'
  | 'login.registerPrompt'
  | 'login.registerSendCode'
  | 'login.registerSubmit'
  | 'login.registerSubmitting'
  ...
  | 'settings.account.errors.invalid_credentials'
  | 'settings.account.errors.network_error'
  | 'settings.account.errors.server_error'
  | 'settings.account.errors.session_expired'
  | 'settings.account.errors.unknown'
  | 'settings.account.group'
  | 'settings.account.logout'
  | 'settings.account.logoutConfirmBody'
  | 'settings.account.logoutConfirmTitle'
  | 'settings.account.needRelogin'
  | 'settings.account.password.confirm'
  | 'settings.account.password.current'
  | 'settings.account.password.mismatch'
  | 'settings.account.password.new'
  | 'settings.account.password.successHint'
  | 'settings.account.password.title'
  | 'settings.account.quota'
  | 'settings.account.title'
  | 'settings.account.usedQuota'
  ...
  | 'settings.newApiLogin.errors.models_failed'
  | 'settings.newApiLogin.errors.network_error'
  | 'settings.newApiLogin.errors.password_login_disabled'
  | 'settings.newApiLogin.errors.rate_limited'
  | 'settings.newApiLogin.errors.requires_2fa'
  | 'settings.newApiLogin.errors.server_error'
  | 'settings.newApiLogin.errors.session_expired'
  | 'settings.newApiLogin.errors.token_create_failed'
  | 'settings.newApiLogin.errors.token_lookup_failed'
  | 'settings.newApiLogin.errors.unknown'
  | 'settings.newApiLogin.group'
  | 'settings.newApiLogin.groupHint'
  | 'settings.newApiLogin.groupPlaceholder'
  | 'settings.newApiLogin.login'
  | 'settings.newApiLogin.noGroups'
  | 'settings.newApiLogin.password'
  ...
  | 'settings.newApiLogin.username'
  | 'settings.newApiLogin.usernamePlaceholder'
